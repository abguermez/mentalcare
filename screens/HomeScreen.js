...
const HomeScreen = ({ route }) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <ScrollView>
        <ImageBackground
          source={require("../assets/HomeGradientTopBG.jpeg")}
          style={styles.topImgBG}
        >
          <View style={styles.topContainer}>
            <BlurView intensity={20} style={styles.blurContainer}>
              <Text style={styles.greetingName}>Hello, {name}</Text>
              <Image
            ...
            <View style={styles.TextAndSearchContainer}>
              ...
              <TouchableOpacity style={styles.bookButton} onPress={() => navigation.navigate("Doctor Lists")}>
